    ...
    return (<PageTransition>
            ...
            {data && <div className="container-custom pt-10 md:pt-20 pb-24 text-white">
                ...
                >
                    ...
                    >
                        <img
                            src={data.logo ? data.logo : 'https://img.freepik.com/free-photo/theater-stage-spotlight_23-2151949833.jpg?t=st=1746836255~exp=1746839855~hmac=ce8c2cd8984e50f332ee8e1512509d6d2b0382cfd0d43dbb44a8a434339d14ce&w=900'}
                            alt={data.name}
